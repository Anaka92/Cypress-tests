describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('anaka92@yandex.com');                   // вводим логин
         cy.get('input[id="k_password"]').type('251548Asdf!!!');               // вводим пароль
         ...
         cy.get('.card_name').type('ANAKA ANAKA');                           // вводим имя владельца действия карты
